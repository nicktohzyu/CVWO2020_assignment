...
class TaggingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tagging" do
    assert_difference('Tagging.count') do
      post taggings_url, params: { tagging: { entry_id: @tagging.entry_id, tag_id: @tagging.tag_id } }
    end
  ...
  test "should update tagging" do
    patch tagging_url(@tagging), params: { tagging: { entry_id: @tagging.entry_id, tag_id: @tagging.tag_id } }
