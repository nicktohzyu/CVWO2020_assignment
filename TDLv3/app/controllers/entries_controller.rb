class EntriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @entry.save
        format.html { redirect_to user_entries_path(@entry), notice: 'Entry was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @entry.update(entry_params)
        format.html { redirect_to edit_user_entry_path(@entry), notice: 'Entry was successfully updated.' }
